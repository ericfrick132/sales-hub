...
public interface IMessageRenderer
{
    ...
    /// <summary>Renderiza un template arbitrario (un step de MessageSteps, un quick-reply, etc.) con los mismos placeholders y spin-text.</summary>
    string RenderTemplate(string template, Lead lead, Product product, Seller? seller = null);
}
